...
if __name__ == "__main__":
    ...
    parser.add_argument('--proto', type=str, default='/home/pi/Desktop/iot_SafeGuard/models/face_mask_detection.prototxt', help='prototxt path')
    parser.add_argument('--model', type=str, default='/home/pi/Desktop/iot_SafeGuard/models/face_mask_detection.caffemodel', help='model path')
